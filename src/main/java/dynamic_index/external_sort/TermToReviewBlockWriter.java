...
public class TermToReviewBlockWriter {
    ...
    public TermToReviewBlockWriter(String indexDirectory, int numOfTokens, String termType) {
        ...
        BLOCK_SIZE_IN_BYTES = BLOCK_SIZE_IN_INT_PAIRS * Statics.PAIR_OF_INT_SIZE_IN_BYTES;
...
//        System.out.println("NEW FILE IN WRITER #" + numOfFilesCreated);
    ...
    public static byte[] toByteArray(List<TermIdReviewIdPair> termIdReviewIdPairs) {
        ...
        if (numOfPairs <= BYTE_ARRAY_MAX_SIZE) {
            listInBytes = new byte[Statics.PAIR_OF_INT_SIZE_IN_BYTES * numOfPairs];
            ...
            for (TermIdReviewIdPair termIdReviewIdPair : termIdReviewIdPairs) {
                ...
                writeToByteArrayOffset += Statics.PAIR_OF_INT_SIZE_IN_BYTES;
            }
...
//            System.out.println("<USED BUFFER WRITING>");
            ...
            int listInBytesSize = Statics.PAIR_OF_INT_SIZE_IN_BYTES * batchSize;
...
//                iterator.remove();
    ...
    private static void insertPairToByteArray(byte[] insertTo, int offset, TermIdReviewIdPair termIdReviewIdPair) {
        final int INTEGER_SIZE = Statics.INTEGER_SIZE;
